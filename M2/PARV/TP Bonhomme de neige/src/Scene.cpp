...
void Scene::AddObject(BonhommeNeige* b){
    bonhomme = b;
}

BonhommeNeige* Scene::GetObject(){
    return bonhomme;
}
...
void Scene::InitShader(){
    ...
    uniformShader.push_back("selected");
