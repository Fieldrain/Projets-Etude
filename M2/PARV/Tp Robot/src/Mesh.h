...
{
public:
	Mesh() {VertexCount = NormalCount = TriangleCount = 0;VertexArray=NULL;NormalArray=NULL;TriangleArray=NULL;}
	~Mesh() {delete [] VertexArray;delete [] NormalArray;delete [] TriangleArray;}
