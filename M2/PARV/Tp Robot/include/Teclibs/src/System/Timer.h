...
public:
    ...
    // | Get misc values
    // +---------
    Float64 GetAverage(TimeUnits Unit = unitCpuClock) { return UnitConv(Unit, AverageTime); };
    IntS64 GetNbCalls() { return NbCalls; };
    IntS64 GetCPUFrequency() { return cpufreq; };
    IntS64 GetSelfCycle() { return selfcycle; };
